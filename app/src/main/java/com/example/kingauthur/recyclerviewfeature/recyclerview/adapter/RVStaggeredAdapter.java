package com.example.kingauthur.recyclerviewfeature.recyclerview.adapter;
 ...
 */
public class RVStaggeredAdapter extends RecyclerView.Adapter<RVStaggeredAdapter.ViewHolder> {
    ...
    public RVStaggeredAdapter(ArrayList<String> data) {
        this.mData = data;
    }
